	...
	public function register_post_type() {
		...
		register_taxonomy( 'portfolio_cat',
			...
			apply_filters( 'a3_portfolio_register_cat_agrs', array(
				...
				'query_var' 			=> true,
				'rewrite' 				=> array(
						'slug'         => empty( $permalinks['category_base'] ) ? _x('portfolio-category', 'slug', 'a3_portfolios') : $permalinks['category_base'],
						'with_front'   => false,
						'hierarchical' => false
					),
			) )
		...
		register_taxonomy( 'portfolio_tag',
			...
			apply_filters( 'a3_portfolio_register_tag_agrs', array(
				...
				'query_var' 			=> true,
				'rewrite' 				=> array(
						'slug'         => empty( $permalinks['tag_base'] ) ? _x('portfolio-tag', 'slug', 'a3_portfolios') : $permalinks['tag_base'],
						'with_front'   => false,
						'hierarchical' => false
					),
	        ) )
