...
class A3_Portfolio_Frontend_Scripts
{
	...
	public function a3_portfolio_custom_style() {
		...
		if ( ! $a3_portfolio_global_settings['enable_cards_description'] ) return;

		$cards_description_line_height = (int)$a3_portfolio_global_settings['cards_description_line_height'];
		$cards_description_line_height = $cards_description_line_height + ( $cards_description_line_height * 0.2 );

		$custom_style = '
<style type="text/css">
	body a.a3-portfolio-item-block .a3-portfolio-card-description div {
